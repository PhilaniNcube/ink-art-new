...
export async function POST(request: Request) {
    ...
    try {
        ...
        if (!res.ok) {
            ...
            console.error(`Failed to get webhook. Status: ${res.status}. Status Text: ${res.statusText}. Body: ${errorBody}`);
        ...
        console.error('An error occurred while trying to get Printify webhook:', error);
