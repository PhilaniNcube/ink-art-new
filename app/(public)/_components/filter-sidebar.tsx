...
const FilterSidebar = ({ categories }: FilterSidebarProps) => {
    ...
    // Parse the categories parameter from the URL into an array of strings
    ...
    const [categoriesFilter, setCategoriesFilter] = useQueryState('categories', parseAsArrayOf(parseAsString))
        ...
        <Sheet open={isOpen} onOpenChange={setIsOpen}>
            ...
            <SheetContent side="right" >
                <div className="flex flex-col space-y-4 p-4">
                    ...
                    <div className="flex flex-col space-y-2">
                        <Label htmlFor="search" className="text-md font-semibold">Search Title</Label>
                    ...
                    <div className="flex items-center space-x-4">
                        <Button variant="default" onClick={() => {
                            router.push(`/search?categories=${categoriesFilter?.join(',')}&query=${search}`)
                            setIsOpen(false)
                        }}>
