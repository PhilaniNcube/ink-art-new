    ...
    <div className='container mx-auto py-4'>
      <section className='grid grid-cols-3 gap-4 lg:h-[65vh] '>
        <div className='col-span-3 lg:col-span-2  h-full rounded-lg flex flex-col justify-center relative'>
          <Image src='https://replicate.delivery/xezq/zBXqgOpgDXJmEFYeMXKKuQelAUJLtvN2ADyEdvbzh3CnqAkUA/tmp8gijn66m.webp' alt='Logo' width={1344} height={768} className='w-full h-full object-cover rounded-lg' />
