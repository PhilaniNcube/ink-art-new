...
export default function ProductImages({ images }: ProductImagesProps) {
  ...
  const filteredImages =
    activePosition === "all"
      ? images
      : images.filter((image) => image.position === activePosition);
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage your product images and positions
          </p>
        </div>
                ...
                {filteredImages.map((image, index) => (
                  ...
                  >
                    <div className="relative aspect-square">
                      ...
                      />
                      {image.is_default && (
                        <Badge className="absolute left-2 top-2">Default</Badge>
                      )}
                    ...
                    <div className="p-2">
                      ...
                      <p className="mt-1 text-xs text-muted-foreground">
                        {image.variant_ids.length} variant
                        {image.variant_ids.length !== 1 ? "s" : ""}
                      </p>
                    </div>
                  </div>
                ))}
